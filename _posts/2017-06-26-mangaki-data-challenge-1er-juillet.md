...
<a href="https://twitter.com/intent/tweet?text=Le Mangaki Data Challenge avec %23KyotoUniversity : début le 1er juillet ! Inscriptions ouvertes sur&amp;url={{ site.url }}{{ page.url }}&amp;related={{ site.author.twitter }}&amp;via={{ site.author.twitter }}" rel="nofollow" target="_blank" title="Share on Twitter">Partagez l'info sur Twitter</a> ou
